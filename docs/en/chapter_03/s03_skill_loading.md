...
```
v1_task_manager/chapter_03/s03_skill_loading.py
```
...
python v1_task_manager/chapter_03/s03_skill_loading.py
```
...
*Based on Code: v1_task_manager/chapter_03/s03_skill_loading.py*
