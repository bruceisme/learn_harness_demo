...
- **源代码**：v1_task_manager/chapter_09/s09_memory_system.py
...
- **文件路径**：v1_task_manager/chapter_09/s09_memory_system.py
- **记忆目录**：`.memory/`（工作区根目录下）
- **索引文件**：`.memory/MEMORY.md`（自动生成）
...
---
*文档版本：v1.0*
*基于代码：v1_task_manager/chapter_09/s09_memory_system.py*
