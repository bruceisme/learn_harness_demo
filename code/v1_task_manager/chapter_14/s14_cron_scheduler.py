...
# -*- coding: utf-8 -*-
"""
s14_cron_scheduler.py - Cron Task Scheduler

Reference: learn-claude-code (https://github.com/shareAI-lab/learn-claude-code)
License: MIT License

This module implements a cron-based task scheduler with persistent storage.
It demonstrates scheduled task management, cron expression parsing, and thread-safe execution.

Features:
    - cron_create: Schedule recurring or one-shot tasks with cron expressions
    - cron_delete: Delete scheduled cron tasks by ID
    - cron_list: List all scheduled cron tasks with status and next run time
    - Background checking: Daemon thread monitors and triggers scheduled tasks
    - Persistent storage: Durable tasks saved to .claude/scheduled_tasks.json
    - Auto-expiry: One-shot tasks auto-delete after 7 days
    - Thread-safe: RLock protects all self.tasks access
...
Documentation:
    - Chinese: docs/zh/chapter_14/s14_cron_scheduler_文档.md
    - English: docs/en/chapter_14/s14_cron_scheduler_doc.md
"""
import os
...
def _build_prompt_str() -> str:
    ...
    return f"\x01\033[2K\r\x02{status_tag}\x01\033[36m\x02s14v2 >> \x01\033[0m\x02"
...
if __name__ == "__main__":
    ...
    print("[s14_v2] Event-driven loop started. Cron tasks will fire without user input.")
